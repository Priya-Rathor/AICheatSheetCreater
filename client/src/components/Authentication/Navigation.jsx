    ...
    <nav className="container mx-auto px-6 py-4">
      ...
      {menuOpen && (
        <div className="md:hidden mt-4 space-y-2">
          <Link to="/home" className="block px-3 py-2 rounded hover:bg-blue-50">Home</Link>
          ...
          <Link to="about-us" className="block px-3 py-2 rounded hover:bg-blue-50">About Us</Link> 
          <Link 
            to="/signup" 
